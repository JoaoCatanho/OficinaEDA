...
int main(int argv, char**argc) {
	...
	int contaCiclo = 0;
	int soundtrack;
	cout << "Deseja ter uma música a tocar enquanto usa a aplicação?" << endl;
	...
	while (!sair) {
		...
		case 'e'://opcao dentro da emergencia para escolher entre grupo ou aluno a abandonar
			...
			SetConsoleTextAttribute(hConsole, 15);
			cout << "Escolha a opção:" << endl << "1 - Remover Aluno/Funcionário" << endl << "2 - Remover Grupo/Departamento" << endl << endl;
			cout << "**** Comando: ";
			cin >> opcao1;
			cin.ignore(1000, '\n');
			switch (opcao1) {
			...
			case 9:
				...
				case 1:
					...
					while (restartaOpcao1de9) {
						cout << endl << "Quer encher a fila com 10 grupos ou só 1?\n\t1.10 grupos;\n\t2.Só 1 grupo." << endl << endl;
						cout << "**** Comando: ";
						cin >> opcao3;
						cin.ignore(1000, '\n');
						switch (opcao3) {
